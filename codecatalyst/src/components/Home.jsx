...
function Home() {
  ...
  const features = [
    ...
    },
    {
      title: "Download File",
      description:
        "Download your code files directly to your device for offline access.",
      icon: "📥",
    },
    {
    ...
    },
    {
      title: "Code Anywhere",
      description:
        "Access your projects and collaborate in real-time from any device.",
      icon: "🌐",
    },
    {
      title: "Rich Editor",
    ...
    },
    {
      ...
      description:
        "Save your files securely and access them anytime when logged in.",
      icon: "🔒",
    },
    {
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            Log in to access advanced features like file saving and personalized
            settings.
          </Typography>
        </motion.div>
      </motion.div>
